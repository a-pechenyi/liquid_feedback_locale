...
["No potential supporters (before begin of voting)"] = "Нема можливих прихильників (до голосування)";
...
["No supporters (before begin of voting)"] = "Прихильники відсутні (до початку голосування)";
...
["Voting comment (last updated: #{timestamp})"] = "Голосування коментарів (останнє оновлення: #{timestamp})";
["Voting comment (optional)"] = "Коментарі до голосування (за бажанням)";
["Voting comment available"] = "Голосування коментарів розпочалося";
