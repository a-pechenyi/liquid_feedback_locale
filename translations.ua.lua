...
["Phone"] = "Телефон";
["Photo"] = "Фотографія";
["Please choose a login name. This name will not be shown to others and is used only by you to login into the system. The login name is case sensitive."] = "Оберіть будь ласка ім’я для входу (login). Це ім’я не показується іншим та використовується лише для Вашої авторизації при воді в систему. Увага, регістр символів імені враховується.";
...
["This name is already taken, please choose another one!"] = "Це ім'я вже використовується, будь-ласка оберіть інше!";
